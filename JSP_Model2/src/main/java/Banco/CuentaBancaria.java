...
public class CuentaBancaria implements Serializable {
    ...
    public static String mensajeError (CuentaBancaria origen, CuentaBancaria destino, String monto){
        if(origen.equals(destino)){
            return "No se puede transferir a la misma cuenta";
        } else if(origen.saldo - Integer.valueOf(monto) < 0){
            return "Excedio el monto restante de la cuenta " + origen.nroCuenta;
        } else if(Integer.valueOf(monto) <= 0){
